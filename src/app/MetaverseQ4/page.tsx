    ...
    >
        <Box bg={"green.100"} p={[2, 4]}>
          <VStack align="stretch" spacing={4}>
            ...
            <br/>
            <br/>
            As you probably know, the ICO (&quot;Initial Coin Offering&quot;) industry has been booming, and it&apos;s completely reinventing the way new startups kickstart themselves. In fact, have a look at Wikipedia&apos;s list of highest crowdfunding projects{' '}<Link
                color={"blue.600"}
              ...
              </Link>, and you&apos;ll notice that blockchain projects absolutely dominate the list.
            </Text></Box>
            ...
            ICO list at ICO Drops{' '}<Link
              ...
              <br/>
              <br/>
              Top-Rated Crypto Token Sales: List of New ICOs, STOs, IEOs and IDOsTop-Rated Crypto Token Sales: List of New ICOs, STOs, IEOs and IDOs{' '}<Link
                color={"blue.600"}
            ...
            <Text
              ...
              mt={-1}
            >
             Read How to Launch an IEO{' '}<Link
                color={"blue.600"}
            ...
            <br/>
            <br/>
            Your first task of the project is to make a google slides presentation on how to start a IEO on the Binance Launch Pad{' '}<Link
                color={"blue.600"}
          ...
          <Heading
            ...
            <Text
              ...
              mt={-1}
            >
             Review the list of top fundraising platforms{' '}<Link
                color={"blue.600"}
            ...
            <br/>
            <br/>
            Your second task of the project is to make a google slides presentation on how to start a IDO on the Polkastarter{' '}<Link
                color={"blue.600"}
                href="https://polkastarter.com/"
              >
               https://polkastarter.com/
            ...
            <br/>
            <br/>
            You can use the openzeppelin crowd sale contracts{' '}<Link
                color={"blue.600"}
                href="https://docs.openzeppelin.com/contracts/4.x/crowdsales"
              >
               https://docs.openzeppelin.com/contracts/4.x/crowdsales
              </Link>{' '}however you will have to update the code to the latest solidity version.
              <br/>
              <br/>
              ...
              <br/>
              <br/>
              Note: Before you get started writing the token contract we suggest you review access control{' '}<Link
                color={"blue.600"}
          ...
          <Heading
            ...
            >
             Read{' '}<Link
              ...
              <br/>
              <br/>
              Now use Gnosis Safe{' '}<Link
                color={"blue.600"}
                href="https://gnosis-safe.io/"
              >
               https://gnosis-safe.io/
              </Link>{' '}with multi-sigs to do what you did in the last part.
            </Text>
            </Box>
            <Heading
              as="h2"
            ...
            >
             Write a Typescript program to send Pako Token to some friend&apos;s address using Ethers.js.
              <br/>
              <br/>
              You may follow this tutorial{' '}<Link
                color={"blue.600"}
            ...
            <Text
              ...
              mt={-1}
            >
              Read this NFT tutorial series{' '}<Link
                color={"blue.600"}
             ...
             https://ethereum.org/en/developers/tutorials/how-to-write-and-deploy-an-nft/
              ...
              <br/>
              <br/>
              Create a NFT contract using the OpenZepplen ERC721 NFT Standard{' '}<Link
                color={"blue.600"}
             ...
             https://docs.openzeppelin.com/contracts/4.x/erc721
              ...
              <br/>
              <br/>
              You may use the Preset ERC721 contract{' '}<Link
                color={"blue.600"}
             ...
             https://docs.openzeppelin.com/contracts/4.x/erc721#Presets
              ...
              <br/>
              <br/>
              Deploy your NFT contract on a testnet, mint it, and view it on the MetaMask wallet and list it on OpenSea Marketplace{' '}<Link
                color={"blue.600"}
             ...
             https://opensea.io/
              ...
              <br/>
              <br/>
              Implement a ERC721 Market{' '}<Link
                color={"blue.600"}
